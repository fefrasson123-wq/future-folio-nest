...
const differentials = [
  {
    icon: Lock,
    title: "Não conecta conta bancária",
  ...
  },
  {
    ...
    description: "Todo seu patrimônio em um só lugar",
  },
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {differentials.map((diff, index) => (
            <div
              key={index}
              className="glass-card p-8 rounded-2xl border border-border/50 hover:neon-border transition-all duration-500 text-center group"
            >
