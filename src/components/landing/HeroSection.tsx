      ...
      <div className="container mx-auto px-6 pt-24 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-foreground/80 max-w-2xl mx-auto mb-10 animate-fade-in-up leading-relaxed font-medium" style={{
            ...
            Acompanhe Ações, Criptomoedas, Fundo Imobiliários, Renda fixa, Bolsa Americana, imóveis e muito mais em uma interface futurista. Com preços atualizados em tempo real mantendo a Segurança total dos seus dados.
          </p>
